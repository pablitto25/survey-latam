...
const atributos = [
  ...
  "El conocimiento del mercado en ti país",
  "La relacion calidad/precio de nuestros productos",
    ...
    <form className="w-full text-black">
      ...
      <div className="">
        ...
        <div className="pt-14 pl-8 pb-14 pr-8">
          <div className="flex flex-row">
            <div>
              <p>¿Quién considera un referente líder en el rubro trade?</p>
            </div>
          </div>
          <div>
            <Textarea
              ...
              placeholder="Enter your description"
              className="w-full"
              name="consideraUnaReferencia"
              value={formData.consideraUnaReferencia}
              onChange={handleChange}
            />
          </div>
        </div>
