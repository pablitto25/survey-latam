    ...
    <form className="w-full text-black">
      ...
      <div className="">
                  ...
                  <table className="table-auto">
                    <thead>
                      <tr className="text-sm">
                        ...
                        <td className="p-3">Dissatisfied</td>
                        <td className="p-3">Neutral</td>
                        <td className="p-3">Satisfied</td>
            ...
            <table className="table-auto">
              <thead>
                <tr className="text-sm">
                  ...
                  <td className="p-3">Insatisfecho</td>
                  <td className="p-3">Neutro</td>
                  <td className="p-3">Satisfecho</td>
        ...
        <div className="flex justify-center items-center">
          <Button type="submit" className="w-40 h-12 bg-[#FF0000] mb-12 text-white text-3xl rounded-full" onClick={handleSubmit}>
