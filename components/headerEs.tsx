    ...
    <header className="relative">
      ...
      <div className="relative mx-auto bg-white max-w-5xl">
        <div className="relative flex items-center justify-center h-auto max-w-full">
          ...
          />
          <div className="absolute top-1/3 left-0 transform -translate-y-1/2 p-4 text-black">
            <h1 className="text-lg text-white font-bold">
              Satisfaction survey {currentYear}
            </h1>
            <h1 className="text-lg text-white">Latamly Group</h1>
          </div>
          <div className="absolute top-1/3 right-[-300px] transform -translate-y-1/2 p-4 text-black">
            <div>
